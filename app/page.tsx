    ...
    <main className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      <section id="story" className="py-16 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-10 lg:grid-cols-2 items-center">
          <img src="/images/story.jpg" alt="Our story" className="aspect-[4/3] w-full rounded-3xl object-cover" />
          <div>
            <h2 className="text-3xl font-bold">A 2000-year-old legend, reborn</h2>
